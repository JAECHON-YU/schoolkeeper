...
?>
	...
	*/
	...
	<ul id="latest-carousel-yt" class="owl-carousel owl-theme mt40">
		<?php
		for ($i=0; $i<$list_count; $i++) {
			...
			if($list[$i]['wr_10']){
				...
				$url = explode('&',$url);
				//$img_content = '<img src="https://img.youtube.com/vi/'.$url[0].'/0.jpg" class="owl-lazy img_selector">';
				$img_content = "<img src='https://img.youtube.com/vi/".$url[0]."/0.jpg' class='img-responsive'style='width:100%;height:".$thumb_height."px'>";
			}else{
		...
		?>
			<li class="mb40">
				<div class="hover_container_3">
					<?php echo $img_content;?>
					<a href="<?php echo $list[$i]['href'] ?>">
						<div class="overlay">
							<div class="hover_text_3">
