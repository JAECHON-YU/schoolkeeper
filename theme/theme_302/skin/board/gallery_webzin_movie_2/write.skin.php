                ...
                <div class="col-sm-12">
					<section id="bo_w">
						...
						<div class="bo_w_link write_div">
							<label for="wr_10"><i class="fa fa-youtube" aria-hidden="true"></i><span class="sound_only"> 링크  #<?php echo $i ?></span></label>
							<input type="text" name="wr_10" value="<?php if($w=="u"){echo $write['wr_10'];} ?>" id="wr_10" class="frm_input full_input" size="50" placeholder="Yutube URL">
						</div>
