            ...
            <div class="row">
				...
				<article id="bo_v" style="width:<?php echo $width; ?>">
					...
					<section id="bo_v_atc">
						...
						<?php
						if($view['wr_10']) {
							$basename = basename($view['wr_10']);
							$url = str_replace("watch?v=","",$basename);
							$url = explode('&',$url);
						?>
							<iframe src="https://www.youtube.com/embed/<?=$url[0]?>" width="100%" height="360" frameborder="0" allowfullscreen></iframe>
						<?php } ?>
						<?php
						// 파일 출력
