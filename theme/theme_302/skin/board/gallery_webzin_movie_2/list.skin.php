										...
										<div class="col-xs-12 col-sm-6 col-md-12" style='margin-bottom:30px;'>
											<div class="blog-post" style='margin-bottom:0;'>
												<div class="row">
													...
													<div class="col-md-2 hidden-xs hidden-sm margin20">
															<?php
															...
															<?php
																...
																if($thumb['src']) {
																	//$img_content = '<img src="'.$thumb['ori'].'" alt="'.$thumb['alt'].'" style="max-width:100%;height:auto">';
																	$img_content = "<img src='".G5_THEME_URL."/img/down1.png' style='max-width:100%;width:100%;height:auto'>";
																} else {
																	//$img_content = '<img src='.G5_THEME_URL.'/img/no-img.png style="max-width:100%;height:auto">';
																	$img_content = "<img src='".G5_THEME_URL."/img/down1.png' style='max-width:100%;width:100%;height:auto'>";
																}
															...
															<?php } else {
																...
																if($thumb['src']) {
																	//$img_content = '<img src="'.$thumb['ori'].'" alt="'.$thumb['alt'].'" style="max-width:100%;width:100%;height:auto">';
																	$img_content = "<img src='".G5_THEME_URL."/img/down1.png' style='max-width:100%;width:100%;height:auto'>";
																} else {
																	//$img_content = '<img src='.G5_THEME_URL.'/img/no-img.png style="max-width:100%;width:100%;height:auto">';
																	$img_content = "<img src='".G5_THEME_URL."/img/down1.png' style='max-width:100%;width:100%;height:auto'>";
																}
													...
													<div class="col-md-10 col-sm-12 col-xs-12 margin20">
														<ul class="list-inline post-detail" style='margin-top:0px;'>
															<li><i class="fa fa-tag"></i> <?=$list[$i]['mb_id']?></li>
															<li><i class="fa fa-calendar"></i> <?php echo $list[$i]['wr_datetime']?></li>
															
														</ul>
														<h2 class="ko"><?php if ($is_category && $list[$i]['ca_name']) {?><a href="<?php echo $list[$i]['ca_name_href'] ?>" class="bo_cate_link">(<?php echo $list[$i]['ca_name'] ?>)</a><?php } ?><a href="<?php echo $list[$i]['href'] ?>"><?php echo $list[$i]['subject']?></a></h2>
														<p>
														<?php echo cut_str(strip_tags($list[$i]['wr_content']),'250','...')?>
														</p>
