...
<article id="bo_v" style="width:<?php echo $width; ?>">
	<header style=" border-top: 3px solid #111; padding-top: 15px;">
		<h2 class="kn f20">
    ...
    <section id="bo_v_info" class="f16">
        <h2>페이지 정보</h2>
    ...
    <section id="bo_v_atc">
        ...
        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con" class="f16"><?php echo get_view_thumbnail($view['content']); ?></div>
