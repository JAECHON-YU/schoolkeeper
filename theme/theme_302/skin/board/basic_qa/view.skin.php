...
// 코멘트 : 새로고침시 먼저 실행
$boname = $g5['write_prefix'].$bo_table;
$sql = "select wr_1 from {$boname} where wr_id = '$wr_id'";
$R = sql_fetch($sql);
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        ...
        <span class="sound_only">작성자</span> <strong>
			<?php //echo $view['name'] ?>
			<?php echo preg_replace("/(^.)./u", "$1○", $view['wr_name']);?>
	...
	<thead>
		<tr>
			<th class="ko f12" style="width:20%;">분류</th>
			<th class="ko f12">내용</th>
		</tr>
	</thead>
	<tbody>
		<tr><td>담당자</td><td><?php echo $view['wr_name']?></td></tr>
		<tr><td>Email</td><td><?php echo $view['wr_email']?></td></tr>
		<tr><td>연락처</td><td><?php echo $view['wr_2']?></td></tr>
		<tr><td>상담가능일자</td><td><?php echo $view['wr_3']?></td></tr>
		<tr><td>상담가능시간</td><td><?php echo $view['wr_4']?></td></tr>
		</tbody>
		</tr>
	</table>
	<?php } ?>
